                        ...
                        var _loop_2 = function (x) {
                            ...
                            if (query.type === 'career') {
                                ...
                                var _loop_3 = function (j) {
                                    // for each year
                                    //  console.log(element.col)     // this is the stat 
                                    //  console.log(element.row[j])
                                    var seasonStats = {};
                                    element.col.forEach(function (stat, i) {
                                        // console.log(element.row[j]);
                                        // if (i === 0) {
                                        //     seasonStats[year] = element.row[j][0]
                                        // }
                                        ...
                                        // typeof stat === 'object' ? seasonStats[stat.data] = element.row[j][i]: seasonStats[stat] = i === 0 ? element.row[j][0] : element.row[j][i];
                                        // console.log(seasonStats[year] + 'year') // set career stat object property   
                                        // console.log(element.row[j][i] + 'element row j i')
...
TestEspn.playerStats({
    ...
    .then(function (stats) { console.log(stats.season); })["catch"](function (err) { return console.log(err); });
