            ...
            return __generator(this, function (_a) {
                ...
                (0, axios_1["default"])(options)
                    ...
                    var _loop_2 = function (x) {
                        var element = statsObject.player.stat.tbl[x];
                        stats.push(element.col.map(function (elem, i) {
                            var stat = {};
                            if (typeof elem === 'object') {
                                stat[elem.data] = element.car[i];
                            }
                            else {
                                stat[elem] = element.car[i];
                            }
                            return stat;
                        }));
                    };
...
TestEspn.playerStats({
    id: '5f09781b6b0b7325049ba91e60d794e6',
    uid: 's:20~l:28~a:2577417',
    guid: '5f09781b6b0b7325049ba91e60d794e6',
    displayName: 'Dak Prescott',
    url: 'http://www.espn.com/nfl/player/_/id/2577417/dak-prescott',
    team: 'Dallas Cowboys'
})
    .then(function (stats) { return console.log(stats); })["catch"](function (err) { return console.log(err); });
