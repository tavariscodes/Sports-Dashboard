            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, (0, axios_1["default"])(options)
                        ...
                        $('script').each(function () {
                            var scriptTagContents = $(this).html();
                            var regex = /(?<=window\[.*?\=).*$/gm;
                        ...
                        // combine teams across conferences into one array
...
TestEspn.teams({ sport: 'nfl' })
    .then(function (teams) { return console.log(teams.length); })["catch"](function (err) { return console.log(err.message); });
